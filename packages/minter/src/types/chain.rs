...
pub const BLOCK_TIME: u64 = 60 * 3; // block time in secs (5x faster than bitcoin)
pub const INIT_BLOCK_REWARD: u64 = 10_00000000; // initial reward (5x less than bitcoin)
